...
local WatermarkLUA = loadstring(game:HttpGet("https://privatebin.net/?41f839264617ab12#x5zfzJUR5xyo2DtujknuVwy3sz7bbPeemUFsmKpLoaX"))();
--
...
}, 
{
	...
	["ShitTalk"] = {
		["Lynx"] = {
			...
			"FYE ONTOP LYNX ONTOP LYNX ONTOP",
			"IS THAT FYE???!!",
			"Here is a wild FYE user in its habitaC",
			"fye >> ALL",
			"fye ON TOP",
			"fye > U",
			"Yea fye js tapped u"
		...
		["AntiAim"] = {
			...
			"Hmmm why arent u hitting me? FYE too good XDDD",
...
Wait(2)
--
local Window = ui:NewWindow{window = {Name = [[<b>fye.<font color="rgb(220, 20, 60)">solutions</font></b>]], Description = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name}, User = {Name = LocalPlayer.Name,Role = 'developer build ID 5abQzYl'}}
...
-- Combat
do 
	local Silent_Aim_Tab = Window:Tab{Name = 'silent', icon = "rbxassetid://6034509987"}
	local Aim_Assist_Tab = Window:Tab{Name = 'assist', icon = "rbxassetid://4483345998"}
	local On_Hit = Window:Tab{Name = 'effects', icon = "rbxassetid://3605022185"}
    -- 
...
-- ESP
do
    local ESP = Window:Tab{Name = 'players', icon = "rbxassetid://6031251516"}
    -- 
...
-- Character
do 
    local Character = Window:Tab{Name = 'self', icon = "rbxassetid://6031215978"}	
	-- 
...
-- Anti-Aim
do 
    local Anti = Window:Tab{Name = 'desync', icon = "rbxassetid://6034754445"}
    -- 
...
-- Lua
do 
    local Settings = Window:Tab{Name = 'config', icon = "rbxassetid://6035067857"}
    -- 
...
-- Scripts
do
    local Scripts = Window:Tab{Name = 'LUA', icon = "rbxassetid://11419714821"}
    -- 
...
-- 
ui:Notify{text = "fye.solutions has loaded in ".. Round(tostring(tick() - utility.LastTick)).. " seconds !", time = 5, style = "loading"}
