...
Wait(2)
--
local Window = ui:NewWindow{window = {Name = [[<b>fye.<font color="rgb(255, 135, 211)">solutions</font></b>]], Description = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name}, User = {Name = LocalPlayer.Name,Role = 'developer build'}}
